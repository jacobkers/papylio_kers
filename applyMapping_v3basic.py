...
transform_matrix_AUTO=autopick.pick_spots_akaze_final.mapping(file_tetra,show=1,bg=0)[0]
#
#file_tetra='H://projects//research practicum//single molecule fluorescence//Matlab//HJA-data from Ivo//hel6_ave.tif'
transform_matrix_MANUAL=autopick.pick_spots_akaze_manual.mapping(file_tetra,show=1,bg=None, tol=0,f=10000)[0]
# alternatives: 
#if 0:
