from trace_analysis.movie.movie import image_info_to_filename, image_info_from_filename
...
def test_image_info_from_filename():
    ...
    image_info = image_info_from_filename(filename)
...
def test_image_info_to_filename():
    ...
    image_info = {'fov_index': 5, 'image_type': 'average', 'frame_range': (10, 50, 2),
                  'illumination_index': 0}
    filename = image_info_to_filename(**image_info)
