...
def mapping(file_tetra='tetraspeck.tif', show=0): #'E:\CMJ trace analysis\\autopick\\tetraspeck.tif'
    # Open image
    ...
    # Match the features
    #this part is working porperly according to the overlayed images
