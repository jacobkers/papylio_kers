...
if __name__ == '__main__':
    ...
    p = Path(__file__).parents[2]  # include two levels up directory where the papilio package lies
...
if __name__ == '__main__':
    ...
    main_path = r'C:/Users/iason/Desktop/traceanalysis/papilio/traces/test_data/DNA08'
