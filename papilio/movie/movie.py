...
# from papilio.movie.background_correction import rollingball
from papilio.movie.background_correction import determine_temporal_background_correction, \
    determine_spatial_background_correction, determine_single_value_background_correction # remove_background, get_threshold
from papilio.timer import Timer
...
class Movie:
    ...
    def type_dict(cls):
        ...
        from papilio.movie.sifx import SifxMovie
        from papilio.movie.pma import PmaMovie
        from papilio.movie.tif import TifMovie
        from papilio.movie.nd2 import ND2Movie
        from papilio.movie.nsk import NskMovie
        from papilio.movie.binary import BinaryMovie
