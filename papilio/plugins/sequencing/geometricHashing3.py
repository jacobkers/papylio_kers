...
from papilio.plugins.sequencing.geometricHashing2 import polygon_area
import matchpoint as mp
...
if __name__ == '__main__':
    # # source = np.loadtxt(r'D:\SURFdrive\Promotie\Code\Python\papilio\papilio\plugins\sequencing\source.txt')
    # source = np.loadtxt(r'D:\SURFdrive\Promotie\Code\Python\papilio\papilio\plugins\sequencing\source3.txt')
    # destination1 = np.loadtxt(r'D:\SURFdrive\Promotie\Code\Python\papilio\papilio\plugins\sequencing\destination.txt')
    # destination2 = np.loadtxt(r'D:\SURFdrive\Promotie\Code\Python\papilio\papilio\plugins\sequencing\destination2.txt')
