...
from papilio.file import File
# from papilio.molecule import Molecules
from papilio.file_collection import FileCollection
...
class Experiment:
    ...
    def determine_flatfield_and_darkfield_corrections(self, files, method='BaSiC', illumination_index=0, frame_index=0,
        ...
        from papilio.movie.basic_shading_correction import spatial_shading_correction
