...
def plot_dwells(dwells_dataframe, dwelltype='dwelltime', save=True):
    ...
    for tau, d, lab, c in zip([tau_all, tau_l, tau_m, tau_r],
        ...
        values, bins = np.histogram(d, bins=20, density=True)
...
#mainPath = './traces'
#mainPath = 'G:/SM-data/20190925_dcas9_DNA06-09_very_crowded/#3.10_streptavidin_1nM_dCas9-crRNA-Cy5_8nM_DNA08-Cy3_G_movies'
#exp = analysis.Experiment(mainPath)
#file = exp.files[0]
#file.exposure_time = 0.1
